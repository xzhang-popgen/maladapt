...
if __name__ == "__main__":
    ...
    DIR_stat = "/u/scratch/x/xinjunzh/simstats_allvar-sel_newtest/partial/"
    os.mkdir(DIR_stat+thisgene)
    
    num_rep = 1000
    
    slim_template = "/u/scratch/x/xinjunzh/slim_sim-sel/"+"h_NEW_sim_cluster_partial_adaptive.slim"
    slim_thisgene = "/u/scratch/x/xinjunzh/slim_sim-sel_newtest/"+thisgene+"-h_NEW_sim_cluster_partial_adaptive_newtest.slim"
    ...
    while rep < num_rep:
        ...
        try:
            ...
            update_par_file(thisgene, slim_template, slim_thisgene,insert,"partial",adm_amount,adm_time,sel_time)
#1. run slim, get tree file
        #os.system('/u/home/x/xinjunzh/slim_build/slim sim_cluster.slim')
        
        #update slim file
            slim_output = "/u/scratch/x/xinjunzh/slim_sim-sel_newtest/"+thisgene +"_allvar_"+ "-slim_output_partial_adaptive.txt"
...
#2. from tree to vcf
            filename = "/u/scratch/x/xinjunzh/slim_sim-sel_newtest/"+thisgene +"_allvar_"+ 'test_partial_adaptive'
            scalingfactor = 10
...
#from vcf to stats 
    ...
    #pos_list.index(these)
            ...
            outputname = thisgene+"output_partial_adaptive_"
