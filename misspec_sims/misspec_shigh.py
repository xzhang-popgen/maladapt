...
if __name__ == "__main__":
    ...
    slim_template = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+"misspec-shigh_"+dominance+"_adaptive.slim"
    slim_thisgene = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene+"-misspec-shigh_"+dominance+"_adaptive_newtest.slim"
    ...
    while rep < num_rep:
        ...
        try:
            ...
            insert = int((int(window_end)+int(window_start))/2)   #find an exon to insert mutation
            adm_time = random.choice(range(8697,8747))   #randomize adm time
            sel_time = random.choice(range(0,61))   #randomize neutrality time period
...
#1. run slim, get tree file
        ...
        #update slim file
            slim_output = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene +"_misspec-shigh_"+ "-slim_output_"+dominance+"_adaptive.txt"
...
#2. from tree to vcf
            filename = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/test_tree/"+thisgene +"_misspec-shigh_"+ 'test_'+dominance+'_adaptive'
            scalingfactor = 10
...
#from vcf to stats 
    ...
    #each = []
            ...
            outputname = thisgene+"_misspec-shigh_"+dominance+"_adaptive_"
