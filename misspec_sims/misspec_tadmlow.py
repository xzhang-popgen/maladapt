...
if __name__ == "__main__":
    ...
    slim_thisgene = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene+"-misspec-tadmlow_"+dominance+"_adaptive_newtest.slim"
    ...
    while rep < num_rep:
        ...
        try:
            ...
            adm_time = random.choice([8677]) #fix adm time, lower than previous low boundary 
            sel_time = random.choice(range(0,61))   #randomize neutrality time 
...
#1. run slim, get tree file
        ...
        #update slim file
            slim_output = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene +"_misspec-tadmlow_"+ "-slim_output_"+dominance+"_adaptive.txt"
...
#2. from tree to vcf
            filename = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/test_tree/"+thisgene +"_misspec-tadmlow_"+ 'test_'+dominance+'_adaptive'
            scalingfactor = 10
...
#from vcf to stats 
    ...
    #each = []
            ...
            outputname = thisgene+"_misspec-tadmlow_"+dominance+"_adaptive_"
