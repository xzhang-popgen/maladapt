...
if __name__ == "__main__":
    ...
    slim_thisgene = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene+"-misspec-tadmhigh_"+dominance+"_adaptive_newtest.slim"
    ...
    while rep < num_rep:
        ...
        try:
            ...
            insert = int((int(window_end)+int(window_start))/2)   
            adm_time = random.choice([8767]) #,8767  
...
#1. run slim, get tree file
        ...
        #update slim file
            slim_output = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene +"_misspec-tadmhigh_"+ "-slim_output_"+dominance+"_adaptive.txt"
...
#2. from tree to vcf
            filename = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/test_tree/"+thisgene +"_misspec-tadmhigh_"+ 'test_'+dominance+'_adaptive'
            scalingfactor = 10
...
#from vcf to stats 
    ...
    #pos_list.index(these)
            ...
            outputname = thisgene+"_misspec-tadmhigh_"+dominance+"_adaptive_"
