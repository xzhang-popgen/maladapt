...
if __name__ == "__main__":
    ...
    slim_thisgene = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene+"-misspec-mhigh_"+dominance+"_adaptive_newtest.slim"
    adm_range = [0.2]#fix adm amount to be high
...
#1. run slim, get tree file
        ...
        #update slim file
            slim_output = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene +"_misspec-mhigh_"+ "-slim_output_"+dominance+"_adaptive.txt"
...
#2. from tree to vcf
            filename = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/test_tree/"+thisgene +"_misspec-mhigh_"+ 'test_'+dominance+'_adaptive'
            scalingfactor = 10
...
#from vcf to stats 
    ...
    #each = []
            ...
            outputname = thisgene+"_misspec-mhigh_"+dominance+"_adaptive_"
