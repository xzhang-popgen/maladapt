...
def find_mut_site_neutral (segfile):
    segs = open(segfile)
    starts = []
    ends = []
    total = 0
...
def update_par_neutral_file(region_name, temp_par, new_par,insert,dominance,adm_amount,adm_time,sel_time): #dominance is a string = "additive" or "recessive" or "partial"
...
if __name__ == "__main__":
    ...
    num_rep = 300    
    slim_template = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+"misspec-neutral_"+dominance+"_adaptive.slim"
    slim_thisgene = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene+"-misspec-neutral_"+dominance+"_adaptive_newtest.slim"    
    adm_range = [0.01,0.02,0.05,0.1]
    rep=0
    while rep < num_rep:
        print(rep)
        try:
            #neutral_amount = neutral_range[rep]
            ...
            update_par_neutral_file(thisgene, slim_template, slim_thisgene,insert,dominance,adm_amount,adm_time,sel_time)
#1. run slim, get tree file
            slim_output = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene +"_misspec-neutral_"+ "-slim_output_"+dominance+"_adaptive.txt"
...
#2. from tree to vcf
            #filename = "/Users/xinjunzhang/Desktop/chr3region_misspec-neutral_test_additive_adaptive"
            filename = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/test_tree/"+thisgene +"_misspec-neutral_"+ 'test_'+dominance+'_adaptive'
            scalingfactor = 10
...
#from vcf to stats 
    ...
    #each = []
            ...
            outputname = thisgene+"_misspec-neutral_"+dominance+"_adaptive_"
