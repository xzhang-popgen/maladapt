...
if __name__ == "__main__":
    ...
    slim_template = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+"misspec-segment_"+dominance+"_CEUdemo.slim"
    slim_thisgene = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene+"-misspec-CEUdemo_"+dominance+"_adaptive_newtest.slim"
...
#1. run slim, get tree file
        ...
        #update slim file
            slim_output = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene +"_misspec-CEUdemo_"+ "-slim_output_"+dominance+"_adaptive.txt"
...
#2. from tree to vcf
            filename = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/test_tree/"+thisgene +"_misspec-CEUdemo_"+ 'test_'+dominance+'_adaptive'
            scalingfactor = 10
...
#from vcf to stats 
    ...
    #len(windows)
            ...
            outputname = thisgene+"_misspec-CEUdemo_"+dominance+"_adaptive_"
