...
def update_par_file(region_name, temp_par, new_par,insert,dominance,adm_amount,adm_time,sel_time): #dominance is a string = "additive" or "recessive" or "partial"
    ...
    for line_counter, line in enumerate(oldfile):
        ...
        if line_counter==readLine:
            #print(fields)
            fields[2] = 'readFile("/u/scratch/x/xinjunzh/slim_nonAIsweep/testing_1k/sim_seq_info_'+str(region_name)+'.txt");'
...
if __name__ == "__main__":
    ...
    slim_thisgene = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene+"-misspec-segment_"+dominance+"_adaptive_newtest.slim"
    ...
    while rep < num_rep:
        ...
        try:
            ...
            window_start,window_end=find_mut_site ("testing_1k/"+thisfile)
...
#1. run slim, get tree file
        ...
        #update slim file
            slim_output = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene +"_misspec-segment_"+ "-slim_output_"+dominance+"_adaptive.txt"
...
#2. from tree to vcf
            filename = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/test_tree/"+thisgene +"_misspec-segment_"+ 'test_'+dominance+'_adaptive'
            scalingfactor = 10
...
#from vcf to stats 
    ...
    #pos_list.index(these)
            ...
            outputname = thisgene+"_misspec-segment_"+dominance+"_adaptive_"
