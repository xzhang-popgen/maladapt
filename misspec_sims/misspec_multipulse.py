...
def update_par_multipulse_file(region_name, temp_par, new_par,insert,dominance,adm_amount,adm_time,sel_time): #dominance is a string = "additive" or "recessive" or "partial"
    ...
    for line_counter, line in enumerate(oldfile):
        ...
        if line_counter==readLine:
            ...
            fields[2] = str(adm_amount/2)+ "," 
            fields[3] = str(1-adm_amount/2)+"));"
        elif line_counter == endadm_timeLine:
            fields[0] = str(adm_time+1)
#second pulse
        elif line_counter == admLine2:
            fields[1] = "c("+str(adm_amount/2)+"));"   
        elif line_counter == sel_timeLine1:
            fields[1] = str(adm_time+sel_time)
            fields[0] = str(adm_time)+":"
        elif line_counter == sel_timeLine2:
...
if __name__ == "__main__":
    ...
    num_rep = 100    
    slim_template = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+"misspec-multipulse_"+dominance+"_adaptive.slim"
    slim_thisgene = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene+"-misspec-multipulse_"+dominance+"_adaptive_newtest.slim"    
    ...
    while rep < num_rep:
        ...
        try:
            ...
            update_par_multipulse_file(thisgene, slim_template, slim_thisgene,insert,dominance,adm_amount,adm_time,sel_time)
#1. run slim, get tree file
            slim_output = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/"+thisgene +"_misspec-multipulse_"+ "-slim_output_"+dominance+"_adaptive.txt"
...
#2. from tree to vcf
            #filename = "/Users/xinjunzhang/Desktop/chr3region_misspec-multipulse_test_additive_adaptive"
            filename = "/u/scratch/x/xinjunzh/slim_nonAIsweep/misspec/"+dominance+"/test_tree/"+thisgene +"_misspec-multipulse_"+ 'test_'+dominance+'_adaptive'
            scalingfactor = 10
...
#from vcf to stats 
    ...
    #len(windows)
            ...
            outputname = thisgene+"_misspec-multipulse_"+dominance+"_adaptive_"
